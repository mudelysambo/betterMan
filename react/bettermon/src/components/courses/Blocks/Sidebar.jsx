...
export default function Sidebar({ activeIndex = 1 }) {
  ...
  var urls = [
    { name: "HTML", url: "/", id: 1 },
    { name: "CSS", url: "/css", id: 2 },
    { name: "Vanilla Javascript", url: "/javascript", id: 3 },
    { name: "Node.js", url: "/nodejs", id: 4 },
    { name: "Database", url: "/database", id: 5 },
  ...
  return (
    <div className="sidebar">
      <div className="icons">
        {
          ...
          activeIndex!==1&&<div  onClick={(e) =>navigate(-1)}>
      ...
      <div className="content" style={{ display: show ? "block" : "none" }}>
        ...
        <div className="heading">Assesment</div>
        <div className="course-list">
        </div>
      </div>
    </div>
