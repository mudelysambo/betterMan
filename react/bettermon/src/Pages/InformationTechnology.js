...
<Card className='card'>
  ...
  <Card.Text>
View Web Development content
  </Card.Text>
  <Button href='/web' variant="primary" role="button" className='p-2'>
              Enroll&raquo;
 </Button>
...
<Card className='card'>
  ...
  <Card.Text>
View Business Intelligence content
  </Card.Text>
  <Button href='/businessintelli' variant="primary" role="button" className='p-2'>
              Enroll&raquo;
            </Button>
...
<Card className='card'>
  ...
  <Card.Text>
  View Programming content
  </Card.Text>
  <Button href='/' variant="primary" role="button" className='p-2'>
              Enroll&raquo;
            </Button>
  </Card.Body>
</Card>
